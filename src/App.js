...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossOrigin="anonymous"></script>
    ...
    <body>
      ...
      <Switch>
        ...
        <Route path='/drugs/list' component={DrugsGrid}/>
        <Route path='/drugs/new' component={NewDrug}/>
        <Route path='/drugs/edit/:drugId' component={EditDrug}/>
        <Route path='/drugs/details/:drugId' component={DrugDetails}/>
      </Switch>
    </body>
